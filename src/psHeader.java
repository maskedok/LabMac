...
//	あとでファイル名の追加してそのファイルに書き込む
	public void psHeader(String title, String page_size) {
		String[] ps_head = {"%!PS-Adobe-3.0 EPSF-3.0",
							"%%Title: "+title,
							"%%Creator: byOKSystem",
							"%%CreationDate: Mon Oct  5 12:26:34 2015",
							"%%Pages: 1",
							"%%BoundingBox: "+page_size,
							...
							"%%EndSetup",
							"",
							"%%Page: TopologySeed_300_0 1",
							"%%PageOrientation: Portrait",
							"/pgsave save def bop",
							"1.0000 inchscale",
							"2.6000 setlinewidth 1072 432 translate",
							"",
							"",
